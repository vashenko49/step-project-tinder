...
export default class ServiceUserAPI {
    ...
    static editUserData = data => axios.put("/api/v0/users", data).then(res => res.data);
    static changePassword = data => axios.put("/api/v0/users/password", data).then(res => res.data);
    static changeImgUser = data => axios.put("/api/v0/users/img", data).then(res => res.data);
}